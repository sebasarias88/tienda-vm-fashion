  ...
  return (
    <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:gap-6">
      <div className="relative min-w-0 flex-1">
        <Search
          size={15}
          className="pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 text-[rgba(248,246,241,0.45)]"
        />
        <input
          type="text"
          ...
          className="w-full border-0 border-b border-[rgba(248,246,241,0.18)] bg-transparent py-3 pl-7 pr-8 text-[13px] font-light text-[#F8F6F1] outline-none transition-colors placeholder:text-[rgba(248,246,241,0.42)] focus:border-[rgba(212,175,55,0.55)]"
        />
        {search && (
          <button
            type="button"
            onClick={() => onSearchChange('')}
            className="absolute right-0 top-1/2 -translate-y-1/2 text-[rgba(248,246,241,0.5)] transition-colors hover:text-[#D4AF37]"
        ...
        {filters.map(f => (
          <button
            ...
            className={`h-10 rounded-[2px] border px-3 text-[10px] font-light uppercase tracking-[1.4px] transition-all ${
              activeFilter === f.id
                ? 'border-[rgba(212,175,55,0.5)] bg-[rgba(212,175,55,0.12)] text-[#D4AF37] shadow-[0_0_12px_rgba(212,175,55,0.08)]'
                : 'border-[rgba(248,246,241,0.14)] text-[rgba(248,246,241,0.62)] hover:border-[rgba(212,175,55,0.32)] hover:text-[#D4AF37]'
            }`}
          >
            {f.label}
          </button>
