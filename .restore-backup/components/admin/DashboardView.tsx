      ...
      <section>
        ...
        <div className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-5 lg:gap-6">
          ...
          <div className="flex flex-col lg:col-span-2">
            ...
            <AdminTableShell className="flex h-full min-h-[22rem] flex-col">
                ...
                {acciones.map(({ href, label, desc, iconKey }, i) => {
                  ...
                  return (
                    <Link
                      key={href}
                      href={href}
                      className={`group flex min-h-[4.5rem] flex-1 items-center gap-4 px-5 py-4 transition-all hover:bg-[rgba(212,175,55,0.07)] hover:shadow-[inset_3px_0_0_#D4AF37] ${
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-0.5 text-[12px] font-light text-[rgba(248,246,241,0.48)]">
                          {desc}
                        </p>
                      </div>
                      <ArrowRight
            ...
            <AdminTableShell className="flex h-full min-h-[22rem] flex-col">
              {productosAgotados.length > 0 ? (
                <ul className="flex flex-1 flex-col">
                  {productosAgotados.map((p, i) => (
                    <li
                      key={p.id}
                      className={`flex flex-1 ${i < productosAgotados.length - 1 ? 'border-b border-[rgba(212,175,55,0.08)]' : ''}`}
                    >
                      <Link
                        href="/admin/productos"
                        className="group flex min-h-[4.5rem] flex-1 items-center gap-4 px-5 py-4 transition-all hover:bg-[rgba(212,175,55,0.07)] hover:shadow-[inset_3px_0_0_#D4AF37]"
                ...
                <div className="flex flex-1 flex-col items-center justify-center px-8 py-16 text-center">
                  <div className="relative mb-5">
                    ...
                    <div className="relative flex h-14 w-14 items-center justify-center rounded-full border border-[rgba(74,222,128,0.3)] bg-[rgba(74,222,128,0.1)] shadow-[0_0_24px_rgba(74,222,128,0.12)]">
                      <Sparkles size={22} className="text-emerald-400" />
                    </div>
                  </div>
                  <p className="text-[15px] font-light text-[#F8F6F1]">
                    Todo el inventario está disponible
                  </p>
                  <p className="mt-2 text-[13px] font-light text-[rgba(248,246,241,0.48)]">
